...
export default function ModalAlert({
  ...
  const textColor = type === 'danger' ? 'text-red-600' : 'text-yellow-600';
  const buttonBgColor = type === 'danger' ? 'bg-red-600 hover:bg-red-500' : 'bg-yellow-600 hover:bg-yellow-500';
            ...
            >
              <div className="sm:flex sm:items-start">
                <div className={`mx-auto flex size-12 shrink-0 items-center justify-center rounded-full ${bgColor} sm:mx-0 sm:size-10`}>
                  <ExclamationTriangleIcon aria-hidden="true" className={`size-6 ${textColor}`} />
                </div>
